...
\begin{lstlisting}[style=camlt, caption={Parte del codice contenuto in main.ml }]
let main () = 
...
\begin{itemize}
	\item \lstinline[style=cmd]|dati|: rimane fermo sulla scelta del grafo fin quando l'utente non seleziona un ID esistente. %TODO: scrivere meglio
...
%TODO: forse può essere suddiviso in sottocapitoli
