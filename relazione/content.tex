...
Se viene inserito un ID invalido si rimane bloccati in questa scelta fin quando un ID corretto
non verrà inserito.
...
\end{figure}
\ \\
Una volta selezionato un ID valido verrà stampato a video il \textit{grafo}, con il \textit{nodo di partenza}, il \textit{massimo numero di colori} ed il \textit{risultato} della fase di colorazione.
